...
- [Content-Box](mate-theme-elemente?id=content-box)
- [CountTo](mate-theme-elemente?id=countto)
- [Einfache Inhaltsbox](mate-theme-elemente?id=einfache-inhaltsbox)
- [Headerbild](mate-theme-elemente?id=headerbild)
- [Kundenstimmen-Slider](mate-theme-elemente?id=kundenstimmen-slider)
- [News-Slider](mate-theme-elemente?id=news-slider)
- [Newsletter-Box](mate-theme-elemente?id=newsletter-box)
- [Parallax-Element](mate-theme-elemente?id=parallax-element)
- [Teaser-Box](mate-theme-elemente?id=teaser-box)
...
In der Version 2.1.0 des Mate Theme ist das CountTo Feature hinzugekommen. Damit können Zahlen hochgezählt werden, wenn Sie in das Sichtfenster gelangen. Ein Beispiel finden Sie in der [Mate Theme Dokumentation](https://mate.pdir.de/mate-elemente.html#countto).

Sollen die Elemente wie im Beispiel nebeneinander dargestellt werden, platzieren Sie **Textelemente** innerhalb eines Elementes vom Typ **Grid (Grid-Start)** und **Grid (Grid-Stop)**. Im Textelement können Sie unter **Erweiterte CSS-Klassen** die Spaltenbreiten festlegen, siehe Bild. Im Abschnitt [Grid](mate-materialize?id=grid) wird dies nochmal genauer beschrieben.
...
In der Version 2.1.0 des Mate Theme ist ein Kundenstimmen-Slider hinzugekommen. Beispiele finden Sie in der [Mate Theme Dokumentation](https://mate.pdir.de/inhaltselemente/content-slider.html).
